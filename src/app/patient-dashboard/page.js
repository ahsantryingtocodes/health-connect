                        ...
                        <div>
                          ...
                          <div className="mt-4">
                            {appointment.consultationType === 'chat' && (
                              <motion.button
                                onClick={() => setActiveChatAppointment(appointment)}
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="w-full px-6 py-3 bg-[#739AF0] text-white rounded-[20px] hover:bg-[#5a7bc0] font-semibold shadow-lg flex items-center justify-center gap-2"
                              >
                            ...
                            {appointment.consultationType === 'video' && (
                              <motion.button
                                onClick={() => setActiveVideoAppointment(appointment)}
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="w-full px-6 py-3 bg-green-500 text-white rounded-[20px] hover:bg-green-600 font-semibold shadow-lg flex items-center justify-center gap-2"
                              >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
